...
void Tablero::construirTablero(Ficha* FV1, Ficha* FV2, Ficha* FV3, Ficha* FV4, Ficha* FR1, Ficha* FR2, Ficha* FR3, Ficha* FR4, Ficha* FA1, Ficha* FA2, Ficha* FA3, Ficha* FA4, Ficha* FZ1, Ficha* FZ2, Ficha* FZ3, Ficha* FZ4) {
    ...
    auto AH1 = new NodoE(A9, new CasillaZonaSegura(0, 0, 'A'), AH2, [](char a){return a == 'A';});
    AF->setSE(AH6);
    AH6->setSE(AH5);
    AH5->setSE(AH4);
    AH4->setSE(AH3);
    ...
    auto VH1 = new NodoE(V9, new CasillaZonaSegura(0, 0, 'V'), VH2, [](char a){return a == 'V';});
    VF->setSE(AH6);
    VH6->setSE(VH5);
    VH5->setSE(VH4);
    VH4->setSE(VH3);
    ...
    auto RH1 = new NodoE(R9, new CasillaZonaSegura(0, 0, 'R'), RH2, [](char a){return a == 'R';});
    RF->setSE(AH6);
    RH6->setSE(RH5);
    RH5->setSE(RH4);
    RH4->setSE(RH3);
    ...
    auto ZH1 = new NodoE(Z9, new CasillaZonaSegura(0, 0, 'Z'), ZH2, [](char a){return a == 'Z';});
    ZF->setSE(AH6);
    ZH6->setSE(ZH5);
    ZH5->setSE(ZH4);
    ZH4->setSE(ZH3);
    ...
    A12->setSO(Z1);
    FV1->setPosicionC(VC1);
    FV2->setPosicionC(VC2);
    FV3->setPosicionC(VC3);
    FV4->setPosicionC(VC4);
    FR1->setPosicionC(RC1);
    FR2->setPosicionC(RC2);
    FR3->setPosicionC(RC3);
    FR4->setPosicionC(RC4);
    FA1->setPosicionC(AC1);
    FA2->setPosicionC(AC2);
    FA3->setPosicionC(AC3);
    FA4->setPosicionC(AC4);
    FZ1->setPosicionC(ZC1);
    FZ2->setPosicionC(ZC2);
    FZ3->setPosicionC(ZC3);
    FZ4->setPosicionC(ZC4);
}
